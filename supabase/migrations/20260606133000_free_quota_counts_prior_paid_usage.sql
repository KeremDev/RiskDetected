-- If a user consumes paid analysis quota and later downgrades to Free on the
-- same Istanbul business day, do not grant an extra Free standard analysis.
-- Free quota is one total analysis/day, counted across standard and detailed

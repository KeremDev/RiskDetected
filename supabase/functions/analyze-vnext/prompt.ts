...
ÖNCE scene_inventory ile görünen ekipman ve kritik bileşenleri çıkar; sonra bütün modülleri tara; sonra mandatory_module_outcomes ve sector_context_evidence alanlarını tamamla; en son hazard_facts ve yalnız gerekli inspection_signals üret. Şemadan sapma, markdown kullanma.`;
}

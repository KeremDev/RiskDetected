...
- entity.equipment_family, entity.component, entity.identity_basis ve control_intents[].target alanları da kullanıcıya gösterilir: bunları da TAM OLARAK istenen çıktı dilinde yaz. "Concrete slab edge", "Portable cable", "Mixer drum" gibi İngilizce adlar Türkçe raporun cümlelerine olduğu gibi yerleştiriliyor; "Beton döşeme kenarı", "Seyyar besleme kablosu", "Mikser tamburu" gibi yaz. Bu alanlarda snake_case veya alt çizgi kullanma.

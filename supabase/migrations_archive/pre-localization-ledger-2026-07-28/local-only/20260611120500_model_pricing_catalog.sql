...
values
  (
    ...
    0.0375,
    0.60,
    'Tahmini Google Gemini 2.5 Flash fiyatı (admin katalog)'
  ),
  (
    'gemini',
    'gemini-2.5-pro',
    ...
    0.3125,
    10.00,
    'Tahmini Google Gemini 2.5 Pro fiyatı (admin katalog)'
  ),
  (
    'gemini',
    ...
    0.01875,
    0.30,
    'Tahmini Gemini 3.1 Flash Lite fiyatı (admin katalog)'
  ),
  (
    'groq',
    ...
    null,
    null,
    'Tahmini Groq Llama 4 Scout fiyatı (admin katalog)'
  )

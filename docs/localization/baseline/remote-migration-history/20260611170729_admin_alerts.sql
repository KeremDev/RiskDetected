...
values
  ('stale_queue', 'Bayat analiz kuyruğu', '15 dakikadan uzun süredir queued durumunda analiz var', 'stale_queue', 'gte', 1, 'critical', 30),
  ('queue_backlog', 'Yüksek kuyruk backlog', 'Bekleyen veya çalışan analiz sayısı eşiği aştı', 'queue_backlog', 'gte', 10, 'warning', 60),
  ('failed_analyses_7d', 'Başarısız analiz artışı', 'Son 7 günde başarısız analiz sayısı yükseldi', 'failed_analyses_7d', 'gte', 5, 'warning', 120),
  ('ai_errors_7d', 'AI hata oranı', 'Son 7 günde AI çağrı hataları eşiği aştı', 'ai_errors_7d', 'gte', 20, 'warning', 120),
  ('subscription_inconsistency', 'Abonelik tutarsızlığı', 'Profil planı ile RevenueCat aboneliği uyuşmuyor', 'subscription_inconsistencies', 'gte', 1, 'critical', 180),
  ('data_quality_high', 'Yüksek öncelikli veri sorunu', 'Veri kalitesi monitöründe yüksek öncelikli kayıt var', 'data_quality_high', 'gte', 1, 'critical', 180),
  ('pending_deletions', 'Silme talebi birikimi', 'Bekleyen hesap silme talebi sayısı arttı', 'pending_deletions', 'gte', 5, 'warning', 240),
  ('health_score_low', 'Düşük operasyon skoru', 'Operasyon sağlık skoru kritik seviyenin altına düştü', 'health_score', 'lte', 70, 'warning', 120)

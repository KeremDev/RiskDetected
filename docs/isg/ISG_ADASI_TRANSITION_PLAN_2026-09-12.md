...
| P05 Firma/personel | P01/P03 | D05 migration; default workplace backfill/catch-up; assignment history; API; iki native liste/form/detail | REV01/21/23, DAT04/05, X07/12/13; composite owner integrity; tekrar backfill temiz | Yeni write read-only; companies legacy okuma/yazma sözleşmesi devam |

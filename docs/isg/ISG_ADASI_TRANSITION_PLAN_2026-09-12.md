...
| P10 Diğer İSG modülleri | P04/P05/P06; P07/P09 entegrasyonları gerektiğinde | §7.5'teki her modül ayrı dilim: model/API/mobile/task/document sözleşmesi; **13 Eylül: beş modül uygulandı, on bir modül açık** | REV03/04/22/23,E08; her satır CRUD+domain+belge+permission | Modül bazlı flag/read-only; başka modülü veya temel ürünü kapatma yok |

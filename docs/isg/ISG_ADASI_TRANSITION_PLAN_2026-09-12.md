...
| P12 Bildirim | P01/P06/P16a; Auth coordinator | Consent provenance; onboarding/profil; producer registry; yeni jobs + eski taşıyıcı; simulate/shadow/canary; **14 Eylül: omurga, rıza kökeni, sahiplik/shadow ve gönderim-anı kapısı uygulandı; sağlayıcı ve cutover açık** | NOTIF/REM ilgili, X47–49; send-time consent ve duplicate sıfır | Producer ownership geri verilir; pending job/version kontrolü; toplu resend yok |

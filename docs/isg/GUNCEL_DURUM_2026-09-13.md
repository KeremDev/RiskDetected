...
| P12 Bildirim | Kısmi; omurga + gönderim güvenliği yerel olarak tamamlandı | Dört amaç, rıza kökeni, üretici sahipliği/shadow. **Devir sonrası:** gerçek zaman ve vade kontrolü, tekil tokenlı gönderim hakkı, paralel kapasite rezervasyonu, güncel izinle retry, backoff ve belirsiz sonuçta otomatik resend yasağı; 38 yeni kabul | Gerçek APNs/FCM/e-posta adaptörleri, kısıtlı işçi ve token yönetimi, P01 tüketicisi, onboarding/native izin yüzeyi, schedule güncelliği, belirsiz sonuç mutabakatı, simulate/canary ve onaylı politika, teslim/okundu metrikleri, gerçek cutover |

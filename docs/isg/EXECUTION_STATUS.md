...
- **13 Eylül Codex devir kontrolü / P12 güvenlik devamı:** `ce4b74fc` kaynak durumu ve Claude'un sunucu dilimleri incelendi. Erken gönderim, plan saatiyle sessiz saat kontrolü, paralel aynı-iş izni ve opt-out sonrası tokensız retry sorunları eski kodda çalıştırılarak üretildi; yeni migration ile tekil gönderim hakkı, güncel izin/politika kontrolü, kapasite rezervasyonu, tokenlı receipt ve belirsiz sonuçta otomatik resend yasağı eklendi. **Son toplu kabul: 754 PASS / 753 tekil ID, upgrade 31 PASS (17 migration, 107 RLS tablo), foundation 245 PASS; cleanup PASS.** Bu güvenlik dilimi tamamlandı; gerçek sağlayıcı/işçi, native rıza akışı ve cutover beklediği için **P12 kapanmadı**. Aşağıdaki 14 Eylül başlıklı kayıtlar önceki devir belgelerinin tarihsel başlıklarıdır. [İnceleme, yapılanlar ve bekleyenler](P12_DISPATCH_SAFETY_2026-09-13.md), [kanıt](evidence/P12_DISPATCH_SAFETY_2026-09-13.json).

- **14 Eylül P13 kişisel not defteri:** firma domaininden tam bağımsız, Free defter; iki metni koruyan çakışma çözümü, diriltilemeyen tombstone, seriden bağımsız occurrence'lar, yerel duvar saatini koruyan DST davranışı ve hatırlatıcı başına tek teslim sahibi eklendi. Sekiz tabloda firma/işyeri/çalışan/entity sütunu yok; üç ana fonksiyon abonelik kontrolü yapmıyor (ikisi de canlı sorguyla doğrulandı). Sentetik koşu **716/716 PASS** (27'si yeni), tam legacy kopya upgrade **29/29 PASS** (16 migration, 107 tablo), foundation 240 PASS. Bu dilimde üretim hatası çıkmadı. **İstemci senkron motoru, cihaz tarafı zamanlama kabulleri ve etiket fonksiyonları açık; P13 kapanmadı.** [Dilim ve sınırlar](P13_PERSONAL_NOTES_2026-09-14.md), [kanıt](evidence/P13_PERSONAL_NOTES_2026-09-14.json).

- **14 Eylül P12 bildirim omurgası:** dört ayrı amaç, rıza kökeni (OS izni pazarlama rızası değil, e-posta ayrı kayıt, eski opt-out korunuyor), `(amaç, episode türü)` başına tek üretici sahipliği ve shadow modu, sahip devrinde bekleyen işlerin iptali, gönderim anında yeniden kontrol (sahiplik/cihaz/kategori/rıza/sessiz saat/sıklık/route) ve teslim iddiası taşımayan deneme kaydı eklendi. Açık kişisel alarm sessiz saate takılmıyor; eski build güvenli ekrana düşüyor; `delivery_confirmed`/`read_confirmed` CHECK ile yalnız false. Sentetik koşu **689/689 PASS** (30'u yeni), tam legacy kopya upgrade **29/29 PASS** (15 migration, 99 tablo), foundation 232 PASS. Bu dilimde iki hata çıktı ve düzeltildi: yalnız izin verilen yolda ortaya çıkan `route` değişken gölgelemesi (42702) ve iki eksik FK indeksi. **Gerçek sağlayıcı adaptörleri, onboarding rıza ekranı, simulate/canary ve gerçek cutover açık; P12 kapanmadı.** [Dilim, hatalar ve sınırlar](P12_NOTIFICATION_CORE_2026-09-14.md), [kanıt](evidence/P12_NOTIFICATION_CORE_2026-09-14.json).

- **14 Eylül P11 belge ve import çekirdeği:** sürümlü şablon yayını, `(firma, kapsam, yıl)` kilidiyle numara tahsisi, finalize anında donan snapshot + SHA-256, PDF/XLSX export defteri ve önizleme/commit/telafi zinciri eklendi. Snapshot kaynağı takip etmiyor, taranmış orijinalden yapısal tablo uydurulmuyor, kimlik isimden türetilmiyor, sağlık sütunu kapıda reddediliyor, bayat önizleme commit edilemiyor ve telafi yalnız değişmemiş kaydı siliyor. Sentetik koşu **659/659 PASS** (38'i yeni), tam legacy kopya upgrade **29/29 PASS** (14 migration, 93 tablo), foundation 224 PASS. Bu dilimde iki gerçek hata çıktı ve düzeltildi: `date + bigint` operatörü yok (42883) ve hata kodu regex'i rakam kabul etmiyordu. **Render worker'ı, güvenli ayrıştırıcı, arama/filtre yüzeyi ve legacy rapor adaptörü açık; P11 kapanmadı.** [Dilim, hatalar ve sınırlar](P11_DOCUMENT_IMPORT_CORE_2026-09-14.md), [kanıt](evidence/P11_DOCUMENT_IMPORT_2026-09-14.json). Devralacak geliştirici için: [devir notu](HANDOVER_CODEX_2026-09-14.md).

- **14 Eylül P10 modül paketi ikinci dilimi:** ISG-KATİP sözleşme takibi, yıllık çalışma planı, yıllık eğitim planı, kurul/karar, çalışma izni formu, saha ziyareti/gözlem ve onaylı defter arşivi eklendi; §7.5'in on iki başlığı artık sunucu tarafında karşılanıyor. Planın "iddia edilmeyecek" dediği üç şey CHECK kısıtıyla **yapısal olarak imkânsız** hale getirildi: resmî entegrasyon, formun işi yetkilendirmesi ve AI metninin resmî kayıt sayılması. Planı kapatmak hiçbir maddeyi gerçekleşmiş yapmıyor; gönüllü kurul yasal skora girmiyor; saha ziyaretinde sağlık sütunu yok. Sentetik koşu **621/621 PASS** (33'ü yeni), tam legacy kopya upgrade **29/29 PASS** (13 migration, 84 tablo, 12 modül anahtarı kapalı), foundation 216 PASS. **Evrak merkezi, belge üretimi, task/bildirim ve skor açık; P10 kapanmadı.** [Dilim ve sınırlar](P10_MODULE_SECOND_2026-09-14.md), [kanıt](evidence/P10_MODULE_SECOND_2026-09-14.json).

- **13 Eylül P10 modül paketi ilk dilimi:** §7.5'in beş modülü (acil durum planı, tatbikat, ekipman/periyodik kontrol, görevlendirme, KKD teslim/iade) kendi domain kurallarıyla eklendi; her modülün ayrı açma/salt-okunur anahtarı var ve bir modülü durdurmak diğerini etkilemiyor. Plan yenilemesi eski belgeyi değiştirmiyor, planlanan tatbikat gerçekleşmiş sayılmıyor, tek sabit yıl bütün ekipmana uygulanmıyor, çakışan görevlendirme ve imkânsız KKD iadesi reddediliyor. Sentetik koşu **588/588 PASS** (33'ü yeni), tam legacy kopya upgrade **29/29 PASS** (12 migration, 74 tablo), foundation 209 PASS. **Kalan on bir modül, belge üretimi, task/bildirim ve skor açık; P10 kapanmadı.** [Dilim ve sınırlar](P10_MODULE_CORE_2026-09-13.md), [kanıt](evidence/P10_MODULE_CORE_2026-09-13.json).

- **13 Eylül P09 uygunsuzluk çekirdeği ilk dilimi:** veritabanında tanımlı 8 durumlu, 16 kenarlı geçiş matrisi; sürüm/gerekçe/atama kuralları; yalnız o döngüye ait kabul edilmiş uzman doğrulamasıyla kapanış; yeniden açmada yeni doğrulama döngüsü; kaynak başına tek kayıt; sürümünü sabitleyen checklist run'ı ve düzeltici aksiyonlar eklendi. Atanan kişi uygulama kullanıcısı değil; legacy `findings` yazılmıyor. Sentetik koşu **555/555 PASS** (28'i yeni; geçiş matrisinin 64 kombinasyonunun tamamı denendi), tam legacy kopya upgrade **28/28 PASS** (11 migration, 65 tablo), foundation 203 PASS. **Saha ekranları, bildirim, skor ve belge üretimi açık; P09 kapanmadı.** [Dilim ve sınırlar](P09_NONCONFORMITY_CORE_2026-09-13.md), [kanıt](evidence/P09_NONCONFORMITY_CORE_2026-09-13.json).

- **13 Eylül P08 risk sürümleme ilk dilimi:** dört revizyon türü kendi tarih etkisiyle (tam yenileme dönem açar, kısmi revizyon yalnız kapsamını etkiler, metadata düzeltmesi ve yeniden tarama vadeyi değiştirmez), gelecek/çok eski tarih kuralları, açık uzman seçimiyle bulgu aktarımı, kaynak drift işareti, tek kazananlı finalize ve güncel sürüm kanıtı olmadan gönderim yasağı eklendi. Legacy analiz/bulgu satırı yazılmıyor, `risk` rollout kapalı, istemci GRANT'i sıfır. Sentetik koşu **527/527 PASS** (38'i yeni), tam legacy kopya upgrade **28/28 PASS** (10 migration, 54 tablo), foundation 196 PASS. **Risk içeriği, belge üretimi, skor ve uygunsuzluk bağlantıları açık; P08 kapanmadı.** [Dilim ve sınırlar](P08_RISK_VERSIONING_2026-09-13.md), [kanıt](evidence/P08_RISK_VERSIONING_2026-09-13.json).

- **13 Eylül P07 eğitim çekirdeği ilk dilimi:** sürümlü katalog ve insan onaylı yayın, işyerine özgü G4 curriculum sürümü, plan/oturum/kayıt, yoklama **birleşim** matematiği, değerlendirme eşiği/deneme sınırı, değişmez tamamlanma ve dış sertifika ayrımı eklendi. Tamamlanan plan P06 yükümlülüğünü kapatıyor — kural motorunun ilk gerçek tüketicisi. **Resmî içerik yüklenmedi** (`content_approved=false`), `training` rollout kapalı, istemci GRANT'i sıfır. Sentetik koşu **489/489 PASS** (43'ü yeni), tam legacy kopya upgrade **28/28 PASS** (9 migration, 49 tablo), foundation 189 PASS. **İçerik onayı, belge üretimi, skor ve bildirim bağlantıları açık; P07 kapanmadı.** [Dilim ve sınırlar](P07_TRAINING_CORE_2026-09-13.md), [kanıt](evidence/P07_TRAINING_CORE_2026-09-13.json).

- **13 Eylül P06 kural çekirdeği ilk dilimi:** mevzuat kaynağı kaydı (checksum + adı belli inceleyen + yazılı gerekçe), sürümlü kural ve insan onaylı yayın kapısı, sınırlı uygulanabilirlik dili, jurisdiction kapısı, takvim aritmetiğine dayalı tarihli yükümlülük/schedule sürümleme ve günlük mutabakat eklendi. **Hiçbir gerçek mevzuat içeriği yüklenmedi**, `rule_engine` rollout kapalı, istemci GRANT'i sıfır. Sentetik koşu **446/446 PASS** (47'si yeni), tam legacy kopya upgrade **28/28 PASS**, foundation 182 PASS. **İçerik doğrulaması, görev/bildirim tüketicileri ve canlı rollout açık; P06 kapanmadı.** [Dilim ve sınırlar](P06_RULE_CORE_2026-09-13.md), [kanıt](evidence/P06_RULE_CORE_2026-09-13.json).

- **13 Eylül P04 dosya çekirdeği ilk dilimi:** amaç bazlı 13 format kabul matrisi, upload intent/karantina durum makinesi, tarayıcı sonucu ayrımı, anti-TOCTOU immutable promotion, türev ayrımı ve gölge depolama rezervasyonu eklendi. `file_core` rollout kapalı, istemci GRANT'i sıfır; bucket/tarayıcı/parser/istemci yüzeyi yok. Sentetik koşu **399/399 PASS** (37'si yeni), tam legacy kopya upgrade **28/28 PASS**, foundation 175 PASS. **Gerçek AV/parser sandbox'ı, DOC/XLS güvenlik fixture'ları, belge üretimi ve import açık; P04 kapanmadı.** [Dilim ve sınırlar](P04_FILE_CORE_2026-09-13.md), [kanıt](evidence/P04_FILE_CORE_2026-09-13.json).

- **13 Eylül P01/P03 tüketici ve kota dilimi:** P05'in ürettiği iki outbox artık gerçek bir dağıtım defteri tarafından tüketiliyor; ayrıca gölge kota rezervasyon defteri ve ölçülmüş eski hak tabanı eklendi. İki migration da rollout kapalı, istemci GRANT'i sıfır ve `authority='shadow'` kilidiyle gelir. Sentetik Auth/PostgREST/DB koşusu **362/362 PASS** (62'si yeni), tam legacy kopya upgrade **28/28 PASS**, Node foundation 169, capacity-shadow 17, nova-design 24, password-auth 7, Deno 350 PASS. **Gerçek tüketici, worker kimliği, onaylı limit/cutoff ve canlı rollout hâlâ açık; P01/P03 kapanmadı.** [Dilim ve sınırlar](P01_P03_DISPATCH_AND_QUOTA_2026-09-13.md), [kanıt](evidence/P01_P03_DISPATCH_QUOTA_2026-09-13.json).

- **13 Eylül P05 kapanış:** P05'e ait geliştirme ve katmanlı yerel kabul tamamlandı; canlı kapalı. İki gerçek native owner/SDK→izole Auth/PostgREST/DB zinciri, sekiz rehber formu, restart/foreground, bağımsız SQL oracle, tarihli/hiyerarşik ekran kabulleri tamamlandı. iOS native 5; Android 7 başarılı aşama ve belgelenmiş selector düzeltmesi; DB/Auth 301, Node 209, Swift 46; Android 374 çalıştırılan + 626 değişmemiş test; iOS ekran 6 tekil senaryonun son sonucu ve iki app Debug PASS. [Kapanış ve kabul ID sınırları](P05_CLOSURE_2026-09-13.md), [güncel tüm fazlar](GUNCEL_DURUM_2026-09-13.md). Aşağıdaki “P05 açık” ifadeleri tarihsel paket durumlarıdır; bu kayıt güncel durumdur. REV21/23 downstream kabulü veya bütün ürün yayını tamamlandı denmez.

- 13 Eylül P05 tarihli rehber form paketi: iki native platformda Gregoryen tarih/aralık/önceki dönem, üst-alt departman ve aynı işyerini yeniden seçme korumaları; seçenek yükleme-retry taslak koruması, değişmez ilişki alanları ve iOS klavye erişimi tamamlandı. Toplu doğrulama: Android 999 (data değişmedi/UP-TO-DATE), Swift 46, iOS ilgili UI 5/5, Node 206 ve iki ana Debug build PASS. **Gerçek native SDK→DB E2E ve tam tarihli/hiyerarşik UI matrisi hâlâ açık; P05 kapanmadı.** [Paket ve kanıt](P05_DIRECTORY_FORM_BATCH_2026-09-13.md). Aşağıdaki sayılar önceki tarihsel koşulardır.

- 13 Eylül güncel P05 paketi: arşivden yeniden etkinleştirme iki native platform ve atomik RPC/audit/outbox'a eklendi; iOS eski form durumunun korunması hatası düzeltildi. Tam legacy yedek kopyasında dört migration/backfill **26/26**, sentetik Auth/HTTP/DB **300 kontrol**, Android **991/991**, iOS tam UI **19/19**, gerçek Simulator Keychain **1/1**, API33 Keystore restart **2 faz** ve ana buildler PASS. **Native UI→SDK→DB E2E ve tarihli/hiyerarşik ekran kabulü açık; P05 bütünüyle kapanmadı.** P01/P06 consumer ve P18/P19/P20 işleri ayrı bağımlılıklar. [P00–P21 güncel yapılan/bekleyen durum dokümanı](GUNCEL_DURUM_2026-09-13.md), [son kanıt](evidence/P05_CURRENT_2026-09-13.json). Aşağıdaki kayıtlar tarihsel dilimlerdir; eski “tam restore/journal açık” notları bu yeni doğrulama kapsamında güncellenmiştir.

- 13 Eylül P05 yönetim bağlantısı: mevcut iOS Profil/Firmalarım ve Android firma yönetimi, gerçek oturum + global/firma özel availability gate + SDK servislerine bağlandı. Kapalı/hatalı durumda eski yönetim, mevcut firma CRUD/paywall korundu. Personel detayından görevlendirme/işveren geçmişi; salt okunur alt ekran ve pending engelleri eklendi. Auth/SQL/HTTP/Advisor291 kayıt, Android990, Swift14, yeni iOS UI2 ve ana buildler PASS. **Tam restore, cihaz journal, native UI→DB E2E, D05 kabul/consumer ve bütün ana kök açık; P05 kapanmadı.** Canlı rollout/deploy yok. [Paket, akış ve devam kapıları](P05_WORKSPACE_CONNECTION_2026-09-13.md). Aşağıdaki kayıtlar tarihsel durumlardır.

- 13 Eylül P05 toplu native/domain paketi: iOS/Android gerçek SDK adaptörleri ve şifreli pending journal uygulaması; işyeri/departman/unvan/dış firma, tarihli context ve görevlendirme migration/API ve native bileşenleri eklendi. Paket sonu birleşik test/düzeltme uygulandı. Ana iOS/Android build, Android unit/UI, Swift ve izole GoTrue/PostgREST/Advisor testleri başarılı. **Production root bağlantısı, tam restore upgrade, cihaz journal ve UI→DB E2E açık; P05 kapanmadı.** Canlıya migration/özellik açılmadı. [Detay, akış, doğrulama ve sıradaki paket](P05_DIRECTORY_AND_NATIVE_SERVICES_2026-09-13.md). Aşağıdaki maddeler önceki tarihsel dilimleri kaydeder.

- 13 Eylül P05 gerçek backend dilimi: mevcut firma/abonelik tablolarına bağlı, rollout varsayılan kapalı gerçek migration eklendi. Name-only CRUD, optional/inline department, owner+canlı session+mevcut Plus/Pro guard, atomik audit/outbox/receipt, backfill/catch-up ve private HTTP sınırı yerelde doğrulandı. Gerçek GoTrue→PostgREST test yolu eklendi; Supabase Advisor'ın bulduğu üç FK indeksi düzeltildi. Auth/migration/HTTP/Advisor221/221, SQL135/135+oracle329/329, foundation159 ve NOVA24 PASS. Native servis/pending kurtarma, tam schema upgrade ve kalan D05 context/görevlendirme/hiyerarşi kapsamı açık; P05 kapatılmadı, canlı deployment yapılmadı. [Migration, akış, testler ve devam noktası](P05_PERSONNEL_MIGRATION_2026-09-13.md).

- 13 Eylül P05 personel rehberi: iki native liste/arama/detay/name-only form/düzenleme/arşiv ekranı eklendi. DB135/135, gerçek yerel Auth148/148, Android design358 + data611, iOS UI16/16 ve son düzeltme2/2, ana iOS ve Android APK build PASS. Foundation154 ve NOVA24 PASS. **P05 açık:** production migration/HTTP/SDK, gerçek paid yetkisi, kalıcı pending kurtarma ve tam context/hiyerarşi/işveren ilişkisi/görevlendirme UI kabulü eksik. UI yalnız sentetik harness'e bağlı; canlıda etkinleştiği iddia edilmiyor. [Dilim, kanıt ve kapanış kapısı](P05_PERSONNEL_DIRECTORY_2026-09-13.md).

- 13 Eylül kullanıcı sadeleştirmesi/P05: ad soyad yeterli, tarih/görev/kod/işyeri sorulmaz; departman boş/mevcut/yeni olabilir. Yeni departman ve çalışan aynı işlemde kaydedilir, Türkçe ad eşleşmesiyle tekrar azaltılır; işe giriş/çıkış NULL kalır. Swift/Kotlin/Deno ortak61'er, Android611/611 + APK, ana iOS build; DB118/118 (yeni19), foundation123/123 ve NOVA24/24 PASS. Plan güncellendi. Ekran/gerçek servis/production bağlantısı henüz açık. [Yeni personel kuralı](P05_SIMPLE_EMPLOYEE_INTAKE_2026-09-13.md).

- 13 Eylül P05 görevlendirme mutation + native/server sözleşmesi: sürüm/idempotency/atomik audit-outbox-receipt, 61 ortak request fixture ve gerçek server parser→izole SQL bağlantısı eklendi. DB99/99 (yeni21), legacy329/329; Swift61/61, Deno62/62, Android core:data550/550 + APK; ana iOS build; foundation120/120 ve nova-design24/24 PASS. CI genişletildi. İlk bağlantı-kesme testindeki süreç adı truncation hatası düzeltildi. Gerçek Auth/paid gate, production migration, native personel CRUD ve event consumer hâlâ açık; P05 tamamlanmadı. [İşlem, sözleşme ve kanıt](P05_ASSIGNMENT_MUTATION_2026-09-13.md).

- 13 Eylül P05 personel/görevlendirme temeli: izole aday şemada departman, görev, çalışan ve tarihli ana görevlendirme; composite FK, GiST çakışma yasağı, istihdam dönemi guard'ları, owner SELECT ve tarihli unvan snapshot'ı eklendi. Yeni 26/26; DB toplam 78/78 + legacy oracle 329/329, foundation 117/117, nova-design 24/24 PASS. 20 çakışan/20 bağımsız işlem ve 10 istihdam tarihi yarışı denendi. İlk hata katmanı beklentisi düzeltildi; üç sentetik container temizlendi. Production migration/API, domain audit/outbox ve native personel CRUD açık; P05 bitmedi. [Kapsam ve tarih kuralları](P05_PERSONNEL_FOUNDATION_2026-09-13.md).
...
- 13 Eylül P02 parola servis dilimi: Android parola girişi, iOS/Android signup ve recovery isteği, 20 ortak Unicode fixture ve SDK hata gizliliği eklendi. Gerçek izole GoTrue/SMTP 132/132; Android core:data 487/487 + APK; Swift 20/20 ve ana iOS build; foundation 111/111; parola guard 7/7; e-posta regresyonu 13/13 PASS. Sunucunun 8 karakter yerine 8 UTF-8 byte ölçmesi ve SDK autoconfirm session import ayrımı kanıtlandı. UI aktivasyonu, amaç koordinatörü/MFA ve gerçek provider teslimi açık; P02 tamamlanmadı. CI genişletildi, canlı ayarlar değişmedi. [Kapsam, akış ve devam noktası](P02_PASSWORD_AUTH_2026-09-13.md), [izole kanıt](evidence/P02_SYNTHETIC_PASSWORD_AUTH_2026-09-13.json).

- 13 Eylül P18 tüm sayfa zemini düzeltmesi: iOS root+pushed hedefler ve Android hedef gövdesi ortak `NovaPageSurface` üzerinden geçiyor; açık gri tuval/beyaz yuvarlak kart ayrımı 17 hedefe uygulandı. İkinci iOS sistem geri düğmesi kaldırıldı. iOS tam UI 11/11; Android 309/309 JVM, lint ve iki APK; ana iOS build PASS. İlk tekil XCUI hittability anomalisi, başarılı tekrarlar ve kapsam sınırları kaydedildi. Bu hâlâ offline sunum katmanıdır; gerçek domain/root entegrasyonu açık. [Kural ve kanıt](P18_PAGE_SURFACES_2026-09-13.md).

- 13 Eylül P02/P18 oturum sahibi dilimi: iOS/Android `NovaSessionHost`, user+session kapsamı, tek kullanımlı availability isteği, uygulanmış hedeflerin kesişimi ve eski scope verisini gizleme eklendi. İki offline QA host'u bu modele bağlandı. Ortak 88 senaryo/399 geçiş; Android toplam 307/307, iOS hostlu UI tam turu 11/11 PASS. SwiftUI render-epoch callback düzeltmesi sonrasında hedefli tekrar ayrıca kanıtta kayıtlıdır. Gerçek Auth/capability API, typed şirket/domain adaptörleri ve canlı root bağlantısı hâlâ açık; bu dilim P02/P18'i kapatmıyor. [Kurallar ve devam noktası](P18_SESSION_HOST_2026-09-13.md), [kanıt](evidence/P18_SESSION_HOST_2026-09-13.json).

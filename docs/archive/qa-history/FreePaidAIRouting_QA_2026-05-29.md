...
Tarih: 2026-05-29T22:32:13.800Z
...
- PASS: Remote analyze function active — ID                                   | NAME                           | SLUG                           | STATUS | VERSION | UPDATED_AT (UTC)       --------------------------------------|--------------------------------|--------------------------------|--------|---------|---------------------    2cbd70f3-4e37-4167-b610-d2d7a306a04b | analyze                        | analyze                        | ACTIVE | 88      | 2026-05-29 13:23:22     dbdbe072-e76c-4f2c-b77a-3b94df100596 | retention-cleanup              | retention-cleanup              | ACTIVE | 29      | 2026-05-16 15:59:30     f8ac9266-ea68-4292-a382-4b4dc5d83545 | send-push-notification         | send-push-notification         | ACTIVE | 25      | 2026-05-21 20:36:20     30c9a44f-cdb8-4b94-90b9-1210e8aa8e73 | generate-excel-report          | generate-excel-report          | ACTIVE | 39      | 2026-05-28 06:45:01     cfd3fbfb-b804-4847-8de5-5ed3bbe79a54 | revenuecat-webhook             | revenuecat-webhook             | ACTIVE | 25      | 2026-05-22 05:25:45     e8d696b5-d5bd-4383-b6d2-689e7623c3d6 | support-contact                | support-contact                | ACTIVE | 20      | 2026-05-17 22:21:25     ba3c073c-6149-49
- PASS: Analyze function ACTIVE — 2cbd70f3-4e37-4167-b610-d2d7a306a04b | analyze                        | analyze                        | ACTIVE | 88      | 2026-05-29 13:23:22
- PASS: Remote ai_usage_logs telemetry columns — 2 row
- PASS: Remote telemetry check constraints — 2 row
- WARN: Recent AI usage route distribution — Son 24 saatte AI usage yok; canlı trafik doğrulanamadı.
- PASS: Recent AI errors — 1 row
- PASS: Remote analyze no-verify-jwt gateway bypass — {"error":"Geçersiz token.","message":"Geçersiz token.","code":"auth_invalid","request_id":"45c6f4a0-197c-4a65-a41b-4386429c4f6c","support_id":"RD-6D3F9BF0","tier":null,"limit":null,"used":null,"feature":null}
- PASS: Canlı E2E temp kullanıcı email doğrulama — 0 row
- PASS: Canlı E2E auth session — temp user 8d4e2797...
- PASS: Canlı E2E analiz kaydı — ec07073c-1d4d-4d67-b14a-eaaba13ec3d2
- PASS: Canlı E2E analyze invoke — queued
- PASS: Canlı E2E worker manuel tetikleme — 1 row
- PASS: Canlı E2E analiz tamamlanma — 11 bulgu
- PASS: Canlı E2E free paid trial telemetry — {"user_plan":"free","quality_tier":"plus","ai_execution_route":"free_paid_trial","provider":"gemini","model":"gemini-2.5-flash","api_key_alias":"gemini_paid_primary","fallback_source":null,"total_tokens":6249,"http_status":200,"error":null,"error_code":null}
- PASS: Canlı E2E free paid trial Pro model kullanmadı — {"model":"gemini-2.5-flash","api_key_alias":"gemini_paid_primary"}
- PASS: Canlı E2E Plus tadı audit — {"model":"gemini-2.5-flash","sectors":[],"provider":"gemini","user_plan":"free","company_id":null,"input_mode":"text","request_id":"qa-free-paid-routing-1780093899341","support_id":"QA-FREE-PAID-1780093899341","max_hazards":14,"min_hazards":11,"user_prompt":null,"company_name":null,"context_hash":"2c90788fc271","quality_tier":"plus","analysis_mode":"standard","api_key_alias":"gemini_paid_primary","hazard_classes":[],"prompt_version":"isg-photo-personalized-v2026-05-20","reference_mode":"short","audit_frequency":null,"fallback_source":null,"gemini_key_pool":"paid","groq_free_model":"meta-llama/llama-4-scout-17b-16e-instruct","totalTokenCount":6249,"promptTokenCount":2162,"certificate_class":null,"ai_execution_route":"free_paid_trial","inline_photo_count":0,"system_prompt_sent":"Sen Türkiye'de 20 yıllık saha deneyimi olan kıdemli bir İSG uzmanısın (A sınıfı). İnşaat, üretim, depo/lojistik,
- PASS: Canlı E2E ikinci free analiz kuyruğu — 202: {"ok":true,"status":"queued","analysis_id":"fedc6675-3d7c-4ddb-98b1-bfe9b6069fb0","queued_photo_count":0,"request_id":"qa-free-paid-routing-second-1780093899341","support_id":"QA-FREE-PAID-SECOND-1780093899341"}
- PASS: Canlı E2E ikinci analiz kota koruması — {"secondFinal":{"status":"failed","status_message":"Günde 1 ücretsiz analiz hakkın doldu. Destek kodu: QA-FREE-PAID-SECOND-1780093899341"},"secondUsageRows":[]}
- PASS: Canlı E2E temp queue cleanup — 0 row
- PASS: Canlı E2E temp kullanıcı cleanup — 0 row

## Notlar

- Temp cleanup email: qa-free-paid-routing-1780093899341@example.com; cleanup rows payload: []

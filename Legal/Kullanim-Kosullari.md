...
Bu metindeki köşeli parantezli alanlar yayın öncesinde gerçek bilgilerle doldurulmalıdır:

- Hizmet sağlayıcı/veri sorumlusu: [Ticaret unvanı veya ad soyad]
- MERSİS/VKN/TCKN: [Bilgi]
- Adres: [Açık adres]
- E-posta: [hukuk/kvkk/destek e-postası]
- Destek kanalı: [Destek adresi veya uygulama içi kanal]
...
Başkasının hesabını kullanamaz, hesabınızı izinsiz kullandıramaz, kimlik veya iletişim bilgilerinizi yanıltıcı şekilde paylaşamazsınız. Yetkisiz kullanım şüphesi varsa [destek e-postası] üzerinden derhal bildirim yapmalısınız.
...
Kullanıcı, hesap silme, analiz silme, rapor silme veya veri taleplerini uygulama içinden ya da [destek e-postası] üzerinden iletebilir. Silme talepleri yasal saklama yükümlülükleri, uyuşmazlıklar, güvenlik kayıtları veya teknik yedekleme süreleri saklı kalmak üzere işleme alınır.

...
- Adres: [Açık adres]
- E-posta/KEP: [KVKK iletişim adresi]
- VERBİS durumu: [Kayıtlı/kayıt muafiyeti değerlendirmesi]

## 1. Veri sorumlusu

Kişisel verileriniz, RiskDetected hizmetini sunan [veri sorumlusu bilgisi] tarafından veri sorumlusu sıfatıyla işlenir.
...
Başvurularınızı [KVKK e-posta/KEP/adres] üzerinden iletebilirsiniz. Başvurular mevzuatta öngörülen sürelerde sonuçlandırılır.
...
Açık rızaya dayalı işlemlerde rızanızı dilediğiniz zaman [KVKK e-posta/adres] üzerinden veya uygulama içi ayarlardan geri çekebilirsiniz. Rızanın geri çekilmesi, geri çekmeden önce yapılan işlemlerin hukuka uygunluğunu etkilemez. Rıza geri çekildiğinde bazı analiz veya rapor özellikleri teknik olarak sunulamayabilir.

## 13. İletişim

KVKK başvuruları ve gizlilik talepleri için:

- E-posta/KEP: [KVKK e-posta/KEP]
- Adres: [Açık adres]
- Uygulama içi başvuru kanalı: [Kanal]

...
const CATALOG_BUILD79_PRESERVATION_OVERRIDES = [
  ...
  ["Onboarding", "onboarding.obtrial.invite.view.uygulamayi.faee4cf2", "Sana uygun ", "The right "],
  ...
  ["Onboarding", "onboarding.obtrial.invite.view.su.an.odeme.yok.5ab25673", "Fiyat ve uygun teklifler App Store'da gösterilir", "Price and eligible offers are shown in the App Store"],
  ["Onboarding", "onboarding.obtrial.invite.view.uygulamayi.ucretsiz.denemeni.istiyoruz.2cbb5618", "Plan seçeneklerini incelemeni istiyoruz", "We want you to review the plan options"],
  ["Onboarding", "onboarding.obtimeline.paywall.view.denemen.bitmeden.sana.hatirlatma.gondeririz.cc0144c2", "Fiyatı ve varsa uygun teklifi App Store onay ekranında doğrula.", "Verify the price and any eligible offer on the App Store confirmation screen."],
  ...
  ["Onboarding", "onboarding.obtrial.invite.view.ucretsiz.84c94af9", "planı", "plan"],
  ...
  ["Onboarding", "onboarding.obtimeline.paywall.view.7.gun.5bf94fa7", "Yenileme", "Renewal"],
  ["Onboarding", "onboarding.obtimeline.paywall.view.devam.edersen.yillik.plan.baslar.istedigin.zaman.68e836a8", "Onaylanan plan App Store şartlarıyla yenilenir; istediğin zaman iptal edebilirsin.", "The approved plan renews under App Store terms; you can cancel at any time."],
  ...
  ["Onboarding", "onboarding.obnotification.permission.view.ucretsiz.denemeniz.bitmeden.once.size.hatirlatac.21ab39bb", "Plan ve teklif bilgilerini bildirimlerden takip edebilirsin", "You can follow plan and offer details in notifications"],
  ["Onboarding", "onboarding.obtrial.invite.view.0.00.ye.dene.c364ad31", "Plan seçeneklerini gör", "View plan options"],
  ...
  ["Onboarding", "onboarding.obtimeline.paywall.view.5.gun.a1306735", "App Store", "App Store"],

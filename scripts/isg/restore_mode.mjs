...
export function parseRestoreMode(args) {
  if (Array.isArray(args) && args.length === 2 && args[0] === '--isolated-copy' && args[1] === '--p05-pilot-upgrade') {
    return { storage:false, sessionGuard:false, synthetic:false, p05PilotUpgrade:true };
  }

...
const q=JSON.parse(raw);if(!['/','/employees','/rpc/read_personnel','/rpc/isg_personnel_read_v1','/rpc/isg_personnel_mutate_v1','/rpc/isg_directory_read_v1','/rpc/isg_directory_mutate_v1','/rpc/isg_context_at_v1','/rpc/isg_workspace_availability_v1','/rpc/isg_notification_device_permission_v1','/rpc/isg_notebook_read_v1','/rpc/isg_notebook_mutate_v1','/rpc/isg_notebook_organize_v1','/rpc/isg_notebook_organization_v1','/rpc/isg_notebook_reminders_v1','/rpc/isg_notebook_reminder_mutate_v1'].includes(q.path)||!['GET','POST'].includes(q.method)||!['public','private_isg'].includes(q.schema))process.exit(2);

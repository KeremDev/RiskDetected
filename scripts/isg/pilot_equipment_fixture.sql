...
-- Stands in for the live objects the Periyodik Kontroller pilot bundle expects
-- to already exist: the P05 pilot gates, the company/workplace scope, the plan
-- check and the two helpers the equipment functions call.
...
CREATE TABLE private_isg.workplaces(company_id uuid NOT NULL,id uuid NOT NULL,
  owner_id uuid NOT NULL,name text NOT NULL,is_archived boolean NOT NULL DEFAULT false,
...
CREATE TABLE private_isg.rollout(feature text PRIMARY KEY,
  ...
  CONSTRAINT rollout_feature_check CHECK(feature='personnel'));
...
LANGUAGE sql IMMUTABLE SET search_path='' AS $$
  SELECT left(btrim(value),max_bytes) $$;
-- The live gates, reduced to the two facts they decide: is this account on the
-- pilot list, and is this company one it was granted.
...
INSERT INTO private_isg.workplaces VALUES
  ('10000000-0000-0000-0000-000000000001','40000000-0000-0000-0000-000000000001','20000000-0000-0000-0000-000000000001','Merkez',false),
  ('10000000-0000-0000-0000-000000000002','40000000-0000-0000-0000-000000000002','20000000-0000-0000-0000-000000000002','Sube',false);

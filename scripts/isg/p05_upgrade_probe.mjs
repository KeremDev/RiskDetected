...
export function probeP05Upgrade({sql,pass,isolatedCopy}) {
  ...
  pass('p05_full_copy_new_schema_rls', sql("SELECT count(*)=30 AND bool_and(rowsecurity) FROM pg_tables WHERE schemaname='private_isg';") === 't');

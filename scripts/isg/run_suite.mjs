...
const suites = {
  ...
  'nova-design': ['--test', 'scripts/isg/nova_tokens.test.mjs', 'scripts/isg/nova_icons.test.mjs', 'scripts/isg/nova_session_host.test.mjs', 'scripts/isg/nova_company_list.test.mjs', 'scripts/isg/nova_analysis_flow.test.mjs', 'scripts/isg/nova_document_tracking.test.mjs', 'scripts/isg/nova_file_library.test.mjs', 'scripts/isg/nova_equipment_checks.test.mjs', 'scripts/isg/nova_risk_assessments.test.mjs', 'scripts/isg/nova_checklists.test.mjs', 'scripts/isg/nova_emergency_plans.test.mjs', 'scripts/isg/nova_drills.test.mjs', 'scripts/isg/nova_ppe_handovers.test.mjs', 'scripts/isg/nova_appointments.test.mjs', 'scripts/isg/nova_notices.test.mjs', 'scripts/isg/nova_education_accordion.test.mjs'],

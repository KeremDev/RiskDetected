...
Tarih: 2026-05-29T13:25:58.624Z
...
- PASS: Remote analyze no-verify-jwt gateway bypass — {"error":"Geçersiz token.","message":"Geçersiz token.","code":"auth_invalid","request_id":"c0081ca4-f980-4dd4-9e98-a9ad8864b9de","support_id":"RD-9F4A3043","tier":null,"limit":null,"used":null,"feature":null}
- PASS: Canlı E2E temp kullanıcı email doğrulama — 0 row
- PASS: Canlı E2E auth session — temp user c0a72f1f...
- PASS: Canlı E2E analiz kaydı — 8edfe24b-2ab4-4edc-8d79-f291647a302e
- PASS: Canlı E2E analyze invoke — queued
- PASS: Canlı E2E worker manuel tetikleme — 1 row
- PASS: Canlı E2E analiz tamamlanma — 12 bulgu
- PASS: Canlı E2E free paid trial telemetry — {"user_plan":"free","quality_tier":"plus","ai_execution_route":"free_paid_trial","provider":"gemini","model":"gemini-2.5-flash","api_key_alias":"gemini_paid_primary","fallback_source":null,"total_tokens":6645,"http_status":200,"error":null,"error_code":null}
- PASS: Canlı E2E free paid trial Pro model kullanmadı — {"model":"gemini-2.5-flash","api_key_alias":"gemini_paid_primary"}
- PASS: Canlı E2E Plus tadı audit — {"model":"gemini-2.5-flash","sectors":[],"provider":"gemini","user_plan":"free","company_id":null,"input_mode":"text","request_id":"qa-free-paid-routing-1780061123000","support_id":"QA-FREE-PAID-1780061123000","max_hazards":14,"min_hazards":11,"user_prompt":null,"company_name":null,"context_hash":"2c90788fc271","quality_tier":"plus","analysis_mode":"standard","api_key_alias":"gemini_paid_primary","hazard_classes":[],"prompt_version":"isg-photo-personalized-v2026-05-20","reference_mode":"short","audit_frequency":null,"fallback_source":null,"gemini_key_pool":"paid","groq_free_model":"meta-llama/llama-4-scout-17b-16e-instruct","totalTokenCount":6645,"promptTokenCount":2162,"certificate_class":null,"ai_execution_route":"free_paid_trial","inline_photo_count":0,"system_prompt_sent":"Sen Türkiye'de 20 yıllık saha deneyimi olan kıdemli bir İSG uzmanısın (A sınıfı). İnşaat, üretim, depo/lojistik,
- PASS: Canlı E2E ikinci free analiz kuyruğu — 202: {"ok":true,"status":"queued","analysis_id":"ef531d7d-2430-4eec-bf9a-532f10f8a4f7","queued_photo_count":0,"request_id":"qa-free-paid-routing-second-1780061123000","support_id":"QA-FREE-PAID-SECOND-1780061123000"}
- PASS: Canlı E2E ikinci analiz kota koruması — {"secondFinal":{"status":"failed","status_message":"Günde 1 ücretsiz analiz hakkın doldu. Destek kodu: QA-FREE-PAID-SECOND-1780061123000"},"secondUsageRows":[]}
- PASS: Canlı E2E temp queue cleanup — 0 row
- PASS: Canlı E2E temp kullanıcı cleanup — 0 row

## Notlar

- Temp cleanup email: qa-free-paid-routing-1780061123000@example.com; cleanup rows payload: []

...
P13 bütünü açık: hatırlatıcı oluşturma/erteleme/tamamlama için aktif-oturumlu native API ve UI, occurrence producer → P12 gönderici bağlantısı, seçili kurulumun tek teslim sahipliği, gönderim anında iptal/sürüm/izin doğrulaması ve gerçek cihaz kabulleri henüz tamamlanmadı. P12 çalışma ortamı/sağlayıcı bağlaması da açık. P14'e geçiş veya P13 faz kapanışı bu belgeyle ilan edilmiyor; üretime migration/rollout/mağaza yayını yapılmadı.

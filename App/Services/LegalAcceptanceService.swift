...
final class LegalAcceptanceService {
    ...
    nonisolated static let kvkkVersion = "kvkk-2026-05-30"
    nonisolated static let termsVersion = "terms-2026-05-30"
    nonisolated static let aiProcessingVersion = "ai-photo-text-processing-2026-05-30"

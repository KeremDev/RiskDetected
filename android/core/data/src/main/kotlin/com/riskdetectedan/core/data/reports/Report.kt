...
private data class GenerateExcelReportBody(
    ...
    @SerialName("company_id") val companyId: String? = null,
    @SerialName("company_name_override") val companyNameOverride: String? = null,
    @SerialName("company_info_override") val companyInfoOverride: String? = null,
    @SerialName("prepared_by_override") val preparedByOverride: String? = null,
...
class ReportsRepository @Inject constructor(
    ...
    suspend fun generateExcelReport(
        ...
        preparedTitleOverride: String? = null,
        certificateNumberOverride: String? = null,
        companyLogoOverrideBytes: ByteArray? = null,
    ): RdResult<Report> = try {
        val result = client.functions.invoke(
            ...
            body = GenerateExcelReportBody(
                ...
                companyInfoOverride = companyInfoOverride?.takeIf { it.isNotBlank() },
                preparedByOverride = preparedByOverride?.takeIf { it.isNotBlank() },
                preparedTitleOverride = preparedTitleOverride?.takeIf { it.isNotBlank() },
                certificateNumberOverride = certificateNumberOverride?.takeIf { it.isNotBlank() },

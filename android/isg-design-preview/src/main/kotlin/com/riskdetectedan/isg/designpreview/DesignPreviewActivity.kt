                ...
                NovaExpertShell(state, "Kerem Kaya", modifier = Modifier.safeDrawingPadding(), hasUnread = notices.any { it.unread },
                    ...
                    when (destination) {
                        ...
                        NovaDestination.drills -> com.riskdetectedan.feature.nova.NovaDrillScreen(PreviewDrillClient, true,
                            onBack = { navigate(NovaDestination.home) })
                        NovaDestination.visits -> com.riskdetectedan.feature.nova.NovaProcessGate(PreviewProcessClient, "site_visit", true,
                            onBack = { navigate(NovaDestination.home) })
                        NovaDestination.checklists -> com.riskdetectedan.feature.nova.NovaChecklistScreen(PreviewChecklistClient, true,
                            onBack = { navigate(NovaDestination.home) })
                        NovaDestination.activity -> com.riskdetectedan.feature.nova.NovaActivityScreen(PreviewActivityClient,
                            onClose = { navigate(NovaDestination.home) }) { _, _ -> navigate(NovaDestination.companies) }
